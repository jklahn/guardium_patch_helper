...
(function()
{
     ...
     *
     * @function Guardium#getApplicationId
     */
     ...
     *
     * @function Guardium#getApplicationBaseUrl
     */
     ...
     *
     * @function Guardium#getSelectedRows
     */
    ...
    this.getItemId = function()
    {
        ...
        throw new Error("Guardium.getItemId is not currently supported on page " + pageName);
    };
     ...
     * <ul>
     * <li> To call a Guardium REST API, path must start with "/api".
    ...
    /**
     * Returns information on the currently logged in Guardium user, including their name and role.
     *
     * @returns {Object} The currently logged in Guardium user.
     *                   WARNING this function uses a synchronous JavaScript call.
     *
     * @function Guardium#getCurrentUser
     */
    this.getCurrentUser = function()
    {
        ...
        this.rest(
        {
            async: false,
            httpMethod: "POST",
            path: this.getWindowOrigin() + "/console/JSON-RPC/Guardium.getUserByPageContext",
            body: JSON.stringify(
            {
                method: "Guardium.getUserByPageContext",
                contextName: "UserList",
                GuardiumCSRF: this.getCookie("GuardiumCSRF"),
                params: null,
                id: "1"
            }),
            onComplete: function()
     ...
     *
     * @function Guardium#openAssetForIpAddress
     */
     ...
     *
     * @function Guardium#openEventSearch
     */
     ...
     * @throws Error if aql is not supplied or if the search results could not be displayed.
     *
     * @function Guardium#openFlowSearch
     */
     ...
     *
     * @function Guardium#getNamedService
     */
     ...
     *
     * @param {Object} service - A service object as returned by {@link Guardium#getNamedService|Guardium.getNamedService}.
     ...
     *
     * @function Guardium#getNamedServiceEndpoint
     */
    ...
    /**
     * Populates an arguments object to be used in a {@link Guardium#rest|Guardium.rest} call to a named service endpoint.
     *
     * @param {Object} restArgs - A possibly empty object which will be populated with arguments for a
     *                            call to {@link Guardium#rest|Guardium.rest}. The properties of restArgs which can be
     ...
     *                            by {@link Guardium#getNamedServiceEndpoint|Guardium.getNamedServiceEndpoint}.
     ...
     *
     * @see {@link Guardium#rest|Guardium.rest}
     *
     * @function Guardium#buildNamedServiceEndpointRestArgs
     */
     ...
     *
     * @param {String} serviceName - See {@link Guardium#getNamedService|Guardium.getNamedService} serviceName.
     * @param {String} serviceVersion - See {@link Guardium#getNamedService|Guardium.getNamedService} serviceVersion.
     * @param {String} endpointName - See {@link Guardium#getNamedServiceEndpoint|Guardium.getNamedServiceEndpoint} endpointName.
     * @param {Object} restArgs - See {@link Guardium#buildNamedServiceEndpointRestArgs|Guardium.buildNamedServiceEndpointRestArgs} restArgs.
     * @param {Object} [parameterValues] - See {@link Guardium#buildNamedServiceEndpointRestArgs|Guardium.buildNamedServiceEndpointRestArgs} parameterValues.
     * @param {Object} [bodyValue] - See {@link Guardium#buildNamedServiceEndpointRestArgs|Guardium.buildNamedServiceEndpointRestArgs} bodyValue.
     *
     * @throws Error if any wrapped function call fails.
     *
     * @function Guardium#callNamedServiceEndpoint
     */
    this.callNamedServiceEndpoint = function(serviceName, serviceVersion, endpointName, restArgs, parameterValues, bodyValue)
    {
        Guardium.rest({
            ...
            onComplete: function() {
                ...
                var service = Guardium.getNamedService(services, serviceName, serviceVersion);
                var endpoint = Guardium.getNamedServiceEndpoint(service, endpointName);
                Guardium.buildNamedServiceEndpointRestArgs(restArgs, endpoint, parameterValues, bodyValue);
                Guardium.rest(restArgs);
            }
        });
    };
     ...
     *
     * @function Guardium#getWindowOrigin
     * @private
     */
    ...
    this.windowOrTab = function(url, tabName)
    {
        ...
        var w = window.open(url, "_blank", "width=900,height=750,scrollbars=yes,resizable=yes");
     ...
     *
     * @function Guardium#buildRestUrl
     * @private
     */
     ...
     *
     * @function Guardium#generateHttpRequest
     * @private
     */
    ...
    var GUARDIUM_CSRF = "GuardiumCSRF";
    ...
    {
        var csrfToken = Guardium.getCookie(GUARDIUM_CSRF);

        if (csrfToken != null)
        {
            httpRequest.setRequestHeader(GUARDIUM_CSRF, csrfToken);
        }
    };
